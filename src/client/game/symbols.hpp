...
namespace game
{
	...
	WEAK symbol<unsigned int(unsigned int parentId, unsigned int name)> GetNewVariable{0x0, 0x1404339E0};
	WEAK symbol<unsigned int(unsigned int parentId, unsigned int index)> GetNewArrayVariable{0x0, 0x140433880};
